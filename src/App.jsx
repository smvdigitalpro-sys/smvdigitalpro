    ...
    <div style={{ background: C.bg, color: C.text, minHeight: "100vh", fontFamily: "'DM Sans',sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, padding: "0 32px", height: 74, display: "flex", alignItems: "center", justifyContent: "space-between", background: sc ? "rgba(6,6,11,.94)" : "transparent", backdropFilter: sc ? "blur(24px)" : "none", borderBottom: sc ? `1px solid ${C.border}` : "none", transition: "all .35s" }}>
        ...
        <div className="dk" style={{ display: "flex", alignItems: "center", gap: 36 }}>
          ...
          <a href="https://calendly.com/smvdigitalpro/30min" target="_blank" rel="noopener noreferrer" style={{ padding: "11px 26px", borderRadius: 12, background: C.gradBtn, border: "none", color: "#fff", fontWeight: 700, fontSize: 13.5, cursor: "pointer", boxShadow: `0 4px 20px ${C.accentGlow}`, transition: "transform .2s", textDecoration: "none", display: "inline-block" }} onMouseEnter={e => e.target.style.transform = "translateY(-1px)"} onMouseLeave={e => e.target.style.transform = "translateY(0)"}>Book Free Consultation →</a>
        </div>
        ...
        {mob && <div style={{ position: "absolute", top: 74, left: 0, right: 0, background: "rgba(6,6,11,.98)", backdropFilter: "blur(24px)", padding: "28px 32px", display: "flex", flexDirection: "column", gap: 8, borderBottom: `1px solid ${C.border}` }}>
          ...
          <a href="https://calendly.com/smvdigitalpro/30min" target="_blank" rel="noopener noreferrer" onClick={() => setMob(false)} style={{ padding: "14px", borderRadius: 12, background: C.gradBtn, border: "none", color: "#fff", fontWeight: 700, fontSize: 15, cursor: "pointer", textDecoration: "none", display: "block", textAlign: "center" }}>Book Free Consultation →</a>
        </div>}
      </nav>
        ...
        <div className="hg" style={{ maxWidth: 1200, width: "100%", display: "flex", alignItems: "center", gap: 64, position: "relative" }}>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 18, flexWrap: "wrap", marginBottom: 60 }}>
              <a href="https://calendly.com/smvdigitalpro/30min" target="_blank" rel="noopener noreferrer" style={{ padding: "21px 46px", borderRadius: 16, background: C.gradBtn, border: "none", color: "#fff", fontWeight: 800, fontSize: 17, cursor: "pointer", boxShadow: `0 8px 40px ${C.accentGlow}`, transition: "transform .2s", textDecoration: "none", display: "inline-block" }} onMouseEnter={e => e.target.style.transform = "translateY(-3px)"} onMouseLeave={e => e.target.style.transform = "translateY(0)"}>Book Free Consultation →</a>
              <div style={{ position: "relative" }}
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          <div style={{ background: C.card, border: `1px solid ${C.borderLight}`, borderRadius: 28, padding: "70px 48px", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <a href="https://calendly.com/smvdigitalpro/30min" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "22px 48px", borderRadius: 16, background: C.gradBtn, border: "none", color: "#fff", fontWeight: 900, fontSize: 18, cursor: "pointer", boxShadow: `0 8px 40px ${C.accentGlow}`, transition: "transform .2s", textDecoration: "none" }} onMouseEnter={e => e.target.style.transform = "translateY(-3px)"} onMouseLeave={e => e.target.style.transform = "translateY(0)"}>Book Free Consultation →</a>
